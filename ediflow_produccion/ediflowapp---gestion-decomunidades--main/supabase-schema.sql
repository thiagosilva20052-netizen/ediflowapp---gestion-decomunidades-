...
-- (Bloque RLS duplicado eliminado. Mantener la primera declaración de RLS y políticas más arriba.)
    );
...
-- (Storage policies for `avatars` must be configured in the Supabase Dashboard.)
