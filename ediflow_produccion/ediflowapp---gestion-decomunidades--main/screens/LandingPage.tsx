...
const LandingPage: React.FC<Props> = ({ onLoginClick, onNavigate }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-white font-sans selection:bg-ediflow-primary/20 selection:text-gray-900">
      ...
      <section className="bg-white dark:bg-[#0A0A0A] py-24 px-6 lg:px-16 border-t border-gray-100 dark:border-white/5 relative z-20 transition-colors">
        <div className="max-w-6xl mx-auto bg-gray-900 border border-gray-800 rounded-[3rem] overflow-hidden shadow-2xl flex flex-col md:flex-row relative">
          ...
          <div className="flex-1 p-10 md:p-14 lg:p-20 relative z-10 flex flex-col justify-center">
            <h2 className="text-3xl md:text-5xl font-light tracking-tight mb-6 leading-tight text-white">
              ¿Pasarían tus conserjes una fiscalización hoy? <span className="font-serif italic text-gray-400 block mt-2 tracking-normal">Descúbrelo en 2 minutos.</span>
            </h2>
          ...
          <div className="flex-1 bg-black relative flex items-center justify-center p-10 md:p-16 overflow-hidden min-h-[400px]">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-gradient-radial from-ediflow-primary/10 to-transparent blur-3xl opacity-50"></div>
            
            <div className="relative z-10 w-full max-w-sm shrink-0 perspective-[1000px]">
              <div className="absolute -top-6 -right-6 z-20 bg-white border border-green-200 px-4 py-2 rounded-xl shadow-xl flex items-center gap-2 animate-[pulse_4s_ease-in-out_infinite] transform translate-translate-z-10 rotate-3">
                <span className="material-symbols-outlined text-green-600 text-lg">hotel_class</span>
                <span className="text-gray-900 text-xs font-bold font-mono">100% APROBADO</span>
              </div>

              <div 
                className="w-full aspect-[3/4] bg-gray-100 rounded-[2.5rem] border-8 border-gray-800 shadow-2xl flex flex-col overflow-hidden relative transition-transform duration-1000"
              ...
              >
                ...
                <div className="bg-gray-900 p-4 border-b border-gray-800 flex items-center justify-between z-10 shrink-0">
                  <span className="text-[9px] text-gray-400 font-mono tracking-widest uppercase font-bold">Módulo OS10</span>
                ...
                <div className="flex-1 bg-white p-5 flex flex-col gap-6 relative z-10">
                  <div>
                  ...
                  <h4 className="text-gray-900 text-sm font-bold leading-relaxed">
                    Si durante su ronda perimetral detecta una persona escalando la reja norte de la comunidad...
                  </h4>

                  <div className="space-y-3 mt-auto">
                    <div className="w-full bg-gray-50 border border-gray-100 rounded-lg p-3 py-2 flex items-center gap-3">
                      <div className="w-5 h-5 rounded-md border border-gray-200 flex items-center justify-center shrink-0">
                        <span className="text-[10px] text-gray-400 font-bold">A</span>
                      </div>
                      <span className="text-xs text-gray-500 font-medium truncate">Observar discretamente.</span>
                    </div>
                    <div className="w-full bg-blue-50 border border-blue-200 shadow-sm rounded-lg p-3 py-2 flex items-center gap-3 relative overflow-hidden">
                      ...
                      <span className="text-xs text-blue-900 font-bold truncate">Llamar al Plan Cuadrante.</span>
                      <span className="material-symbols-outlined text-blue-600 text-[14px] absolute right-3">check_circle</span>
                    </div>
                  </div>
                </div>
              </div>
